 ...
 * @author LENOVO
 */
public final class QuanLyHocVien extends javax.swing.JPanel {
    ...
    public QuanLyHocVien() {
     ...
     public void taiDuLieu() {
        try {
            ...
            tablemain.getSelectionModel().addListSelectionListener((ListSelectionEvent e) -> {
                if (tablemain.getSelectedRow() >= 0) {
                    mhv.setText(tablemain.getValueAt(tablemain.getSelectedRow(), 0) + "");
                    ten.setText(tablemain.getValueAt(tablemain.getSelectedRow(), 1) + "");
                    ngaysinh.setText(tablemain.getValueAt(tablemain.getSelectedRow(), 2) + "");
                    sdt.setText(tablemain.getValueAt(tablemain.getSelectedRow(), 3) + "");
                    email.setText(tablemain.getValueAt(tablemain.getSelectedRow(), 4) + "");
                    nam.setText(tablemain.getValueAt(tablemain.getSelectedRow(), 5) + "");
                    nu.setText(tablemain.getValueAt(tablemain.getSelectedRow(), 5) + "");
                    diachi.setText(tablemain.getValueAt(tablemain.getSelectedRow(), 6) + "");
                }
            });
    ...
    private void XoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XoaActionPerformed
        ...
        else
        {
            try {
                ...
                if(tablemain.getColumnCount()==0){
                    JOptionPane.showConfirmDialog(this,"Bảng Trống");
                }else {
                    sp.setString(1,tablemain.getValueAt(tablemain.getSelectedRow(),0).toString());
